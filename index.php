...
<nav id="navbar">
    ...
    <?php } else { ?>
        ...
        <li><a href="messages" style="color: rgb(13,110,253);" data-bs-toggle="tooltip" data-bs-placement="top"
               title="En cours de développement">Messages</a></li>
...
switch ($page) {
    ...
    case "deconnexion" :
        ...
        break;
    case "pdf" : 
        require_once("gestion_pdf.php");
        break;
    default :
        require_once("404.php");
}

require_once("vue/cookieconnect.php");
