		...
		<div class="wrap-login100 reveal-1 mb-5">
			<form method="post" action="" class="login100-form validate-form">
				...
				<div class="wrap-input100 validate-input" data-validate="Veuillez saisir une adresse email">
					<input type="email" name="email" placeholder="Adresse email" class="input100">
					<span class="focus-input100" data-placeholder="&#xf207;"></span>
				</div>
				<div class="wrap-input100 validate-input" data-validate="Veuillez saisir un mot de passe">
					<input type="password" name="mdp" placeholder="Mot de passe" class="input100">
					<span class="focus-input100" data-placeholder="&#xf191;"></span>
				</div>
				<input type="hidden" name="nbTentatives" value="<?= $nbTentatives; ?>">
				<div align="right">
					<a href="recuperation-mdp" class="text-light">Mot de passe oublié ?</a>
				</div>
				<div class="contact100-form-checkbox">
  					<input type="checkbox" name="remember-me" id="remember" class="input-checkbox100" checked>
  					<label for="remember" class="label-checkbox100 fs-6" style="font-family: Comic Sans MS, sans-serif;">Se souvenir de moi</label>
				</div>
