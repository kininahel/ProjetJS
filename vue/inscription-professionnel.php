			...
			<div class="formulaire">
				<form method="post" action="" class="login100-form validate-form">
					...
					<div class="row mb-5">
                        ...
                        <div class="col-6">
                            <div class="wrap-input100">
                                <input type="text" name="statut" id="statut" spellcheck="false" maxlength="50" placeholder="Votre statut juridique" class="input100 statut" onblur="traiterStatut()">
                                <span class="focus-input100" data-placeholder="&#xf207;"></span>
                                <span class="counter" id="counterStatut">50</span>
                            </div>
                        </div>
					</div>
					<input type="hidden" name="role" value="Client">
					<div class="container-login100-form-btn" style="justify-content: center;">
						<button type="submit" name="InscriptionProfessionnel" class="btn btn-lg text-light fw-bold" style="background-color: #008080; border-color: #AFEEEE;">
							Créer un compte
						</button>
					</div>
				</form>
...
<script type="text/javascript">
    ...
    // Compteur de caractères pour le statut (juridique)
    const statut = document.getElementById("statut")
    counterStatut = document.querySelector("form #counterStatut"),
    maxLengthStatut = statut.getAttribute("maxlength");
    statut.onkeyup = ()=> {
        counterStatut.innerText = maxLengthStatut - statut.value.length;
    }
