<!-- À RETIRER UNE FOIS LA PAGE TERMINER -->
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select name="id_dest" class="form-select">
                            ...
                            ?>
                                <option value="<?= $unClient['idClient']; ?>"><?= $unClient['prenom']; ?> <?= $unClient['nom']; ?></option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="mb-3">
                    ...
                    <table class="table table-dark table-striped text-center">
                        ...
                        <?php if ($lesMessages) { ?>
                            <?php foreach ($lesMessages as $unMessage) { ?>
                                <tr>
                                    <td><?= $unMessage['id_exp'] ?></td>
                                    <td><?= $unMessage['contenu'] ?></td>
                                    <td>
                                        <a href="" class="btn btn-success me-2">
                                            Répondre
                                        </a>
                                        <a href="messages&action=sup&id_exp=<?= $unMessage['id_exp']; ?>" class="btn btn-danger" onclick="return(confirm('Voulez-vous vraiment supprimer ce message ?'));">
                                            Supprimer
                                        </a>
                                    </td>
                                </tr>
